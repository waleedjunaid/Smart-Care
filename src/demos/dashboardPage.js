  ...
  doughnut: {
    data: {
      datasets: [
        {
          data: [20, 30, 40, 50],
          backgroundColor: ['#f85032', '#fd7e14', '#45b649', '#00c9ff'],
          label: 'Dataset 1',
        },
      ],
      ...
      datasets: [
        {
          ...
          borderColor: '#6a82fb',
          backgroundColor: '#6a82fb',
          data: [0, 1000, 2000, 3000, 2500, 5000, 6000],
        },
        {
          label: 'Processing',
          borderColor: '#fc5c7d',
          backgroundColor: '#fc5c7d',
          data: [50, 400, 500, 600, 300, 800, 900],
        },
        {
          label: 'Delivered',
          borderColor: '#45b649',
          backgroundColor: '#45b649',
          data: [1000, 2000, 4000, 5000, 700, 800, 900],
        },
        {
          label: 'Overall Order',
          borderColor: '#00c9ff',
          backgroundColor: '#00c9ff',
          data: [1550, 1300, 2200, 3400, 4600, 3500, 5000],
        },
      ],
    },
    options: {
